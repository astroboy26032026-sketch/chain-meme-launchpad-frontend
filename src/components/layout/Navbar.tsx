    ...
    <div>
      ...
      <div className="flex flex-col gap-2 sidebar-menu">
        ...
        <button
          ...
          className="w-full font-semibold mt-4 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm text-white border border-[var(--primary)] hover:opacity-90 transition-all"
          style={{ background: 'linear-gradient(135deg, rgba(var(--primary-rgb,124,111,255),0.15) 0%, rgba(var(--accent-rgb,80,200,200),0.10) 100%)' }}
        >
