...
// Auth-specific API: challenge, login, me, refresh, logout
// Token storage is unified via api/core.ts

import axios from 'axios';
import { setAuthToken, getStoredToken } from '@/utils/api/core';
...
// ---- token storage (delegates to core) ----
export function setToken(token?: string) {
  setAuthToken(token ?? null, true);
}
